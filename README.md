...
PTSource Developer Platform is a free professional IDE, Source Code Editor and Compiler, tools, templates and  libs for professionals and students. It offers many powerful features for programming languages and syntax highlighing for over 100 languages. It already brings integrates and Harbour and MingGW-w64 as a native language and compiler but supports a wide variety of programming languages and assemblers such has MASM, NASM, FASM, TASM, Borland C, Bcet Basic, Free Pascal and FreeBASIC.
...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| PTSource Native | C/CLI | :white_check_mark: | :white_check_mark: | :white_check_mark: |
