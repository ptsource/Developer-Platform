...
if {[tk windowingsystem] eq "x11"} {
    ...
    image create photo TclPowered \
	    -file [file join demos images logo64.gif]
...
proc invoke index {
    ...
    uplevel [list source [file join demos $demo.tcl]]
    update
...
#	    -row 1 -column 0 -rowspan 1 -columnspan 1 -sticky news
    ...
    wm title .code "Demo code: [file join demos $file]"
    wm iconname .code $file
    set id [open [file join demos $file]]
