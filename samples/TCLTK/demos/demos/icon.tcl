...
image create bitmap flagup \
	-file [file join demos images flagup.bmp] \
	-maskfile [file join demos images flagup.bmp]
image create bitmap flagdown \
	-file [file join demos images flagdown.bmp] \
	-maskfile [file join demos images flagdown.bmp]
...
checkbutton $w.frame.b2 \
	-bitmap @[file join demos images letters.bmp] \
...
radiobutton $w.frame.left.b4 \
	-bitmap @[file join demos images noletter.bmp] \
