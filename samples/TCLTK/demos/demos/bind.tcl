...
$w.text tag bind d1 <1> {source [file join demos items.tcl]}
$w.text tag bind d2 <1> {source [file join demos plot.tcl]}
$w.text tag bind d3 <1> {source [file join demos ctext.tcl]}
$w.text tag bind d4 <1> {source [file join demos arrow.tcl]}
$w.text tag bind d5 <1> {source [file join demos ruler.tcl]}
$w.text tag bind d6 <1> {source [file join demos cscroll.tcl]}
